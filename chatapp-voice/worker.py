...
def openai_process_message(user_message):
    ...
    openai.api_key = "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"
    openai_response = openai.chat.completions.create(model="gpt-3.5-turbo", messages=messages)
